#
#  Be sure to run `pod spec lint GMGridView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/rojo69/GMGridView"
  ...
  s.author             = { "rojo69" => "email@address.com" }
  # Or just: s.author    = "rojo69"
  # s.authors            = { "rojo69" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/rojo69"
  ...
  s.source       = { :git => "https://github.com/rojo69/GMGridView.git", :commit => :head }
